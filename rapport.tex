...
p4------+
  ...
  \subsection{Interface graphique}
    ...
    \afterpage{
      ...
      \begin{landscape}
        \thispagestyle{empty}
        \begin{figure}[p]
          \makebox[\paperwidth][c]{\includegraphics[width=25cm]{guiuml.pdf}}
  ...
  \subsection{Raytracer}
    ...
    Pour celà, on aurait pu définir un \textit{epsilon} et vérifier que la distance y soit supérieure, mais
    celà entraînait des problèmes de pixels complètement différent des autres, et il aurait fallu trouver
    une valeur adéquate pour \textit{epsilon}. Nous avons donc décidé de ne pas utiliser ce système, et tout
    simplement d'ignorer l'objet qui intersecte, lors du lancer de rayon.
    La méthode \verb+rayColor+, à donc un paramètre (pouvant être nul), qui indique si elle doit ignorer un objet.
    ...
    Toutefois, cette méthode est très coûteuse en calcul.
